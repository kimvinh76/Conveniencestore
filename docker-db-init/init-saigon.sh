...
echo "Đang tạo Database Store_SG..."
/opt/mssql-tools18/bin/sqlcmd -C -S localhost -U sa -P "$MSSQL_SA_PASSWORD" -Q "CREATE DATABASE [Store_SG];"

echo "Đang nạp dữ liệu Saigon..."
...
echo "=== HOÀN THÀNH SETUP SAIGON NODE ==="
