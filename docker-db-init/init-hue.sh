...
echo "Đang tạo Database Store_H..."
/opt/mssql-tools18/bin/sqlcmd -C -S localhost -U sa -P "$MSSQL_SA_PASSWORD" -Q "CREATE DATABASE [Store_H];"

echo "Đang nạp dữ liệu Hue..."
...
echo "=== HOÀN THÀNH SETUP HUE NODE ==="
