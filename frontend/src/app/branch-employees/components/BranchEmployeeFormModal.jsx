...
const BranchEmployeeFormModal = forwardRef(function BranchEmployeeFormModal({ form, setForm, isEditing, handleSubmit, onClose }, ref) {
  return (
    <dialog ref={ref} className="modal w-full max-w-md bg-white rounded-2xl shadow-2xl p-0 backdrop:bg-slate-900/50">
      ...
      <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-4">
        ...
        <label className="flex flex-col gap-1">
          ...
          <input type="email" value={form.Email || ''} onChange={(e) => setForm({ ...form, Email: e.target.value })} className="px-4 py-2 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-teal-500" />
        </label>
...
export default BranchEmployeeFormModal;