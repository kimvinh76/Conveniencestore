      ...
      <div className="flex flex-col gap-6 w-full">
        ...
        <section className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 min-h-[500px]">
          ...
          <div className="table-wrap">
            {loading ? <p className="py-10 text-center text-slate-500">Đang tải dữ liệu hóa đơn...</p> : <DataTable rows={filteredInvoices} columns={["MaHD","MaNV","NgayTao","TongTien"]} onRowClick={openDetails} />}
          </div>
        </section>
      </div>
