    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg z-10 overflow-hidden flex flex-col max-h-[90vh]">
        <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-teal-50">
          <h3 className="text-xl font-bold text-teal-900">Chi tiết sản phẩm</h3>
          <button onClick={onClose} className="text-teal-600 hover:text-teal-800 font-bold text-xl">✕</button>
        </div>
            ...
            <div className="flex flex-col gap-5">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm font-semibold text-teal-600 mb-1">{product.productCode}</p>
                  <span className={`text-xs px-2 py-1 rounded font-bold ${product.active ? 'bg-teal-100 text-teal-700' : 'bg-rose-100 text-rose-700'}`}>
